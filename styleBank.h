...
#ifndef POGUE_STYLEBANK_H
#define POGUE_STYLEBANK_H
...
public:
    ...
    void print_stacks() {
        for (unsigned int i = 0; i < style_stack.size(); i++) {
            cout << style_stack[i] << ", ";
            cout << endl;
        }
        for (unsigned int i = 0; i < color_stack.size(); i++) {
            cout << color_stack[i] << ", ";
            cout << endl;
        }
    }
